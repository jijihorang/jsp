...
<body>
    <%--
          웹 애플리케이션 당 하나만 생성
          모든 JSP 페이지에서 접근 가능
          ServletContext 타입 : 하나의 서블릿이 서블릿 컨테이너와 통신하기 위해서 사용되는 메소드들을 가진 클래스

          보통 웹 애플리케이션 전체에서 사용되는 정보를 저장하거나 서버 정보, 서버 물리적 경로를 가져오는데 사용함.
    ...
    <ul>
      ...
      <li>내장 객체를 파라미터로 전달 : <%=useImplictObject(application)%></li>
    </ul>
