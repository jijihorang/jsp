...
<%--
    ...
    domain : 쿠키를 적용할 도메인
    path : 쿠키를 적용할 경로
    maxAge : 쿠키 유지기간  (단위 : 초 => 하루 : 86400초)

    name은 문자열을 입력하는데 ' , ; space' 등은 포함 x
    path는 특정 경로 입력하면 그 하위 경로도 포함
    age를 설정 안하면 브라우저 종료될 때 쿠키 만료
    getAge age 설정 안 했을 시 '-1'로 반환
--%>
<html>
<head>
    <meta charset="UTF-8">
